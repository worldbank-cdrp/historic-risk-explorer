...
export const DISASTERS = [
  {
    ...
    disasterIntro: '<p>A magnitude 8.8 earthquake occurred off the coast of central Chile on Saturday, 27 February 2010 at 03:34 am local time. The earthquake took place along the tectonic plate boundary between the Nazca and South American plates, with its epicenter off the coast of Pelluhue in the Maule Region and a focal depth of 30 km.</p>',
    disasterDescription: '<p> This was the fifth biggest earthquake to have occurred on Earth since 1900 and the largest to occur in Chile since the M9.2 earthquake of May 22, 1960. The earthquake generated a tsunami that struck the coast of Chile between Viña del Mar in the North and Arauco in the South, causing serious damage to the Talcahuano port and significant loss of lives in Constitución, Pelluhue, Talcahuano, Dichato and the Juan Fernandez Islands. Damage due to ground shaking occurred over a very wide area, affecting 5 regions, where 75% of Chileans live.</p>',
  ...
  },
  {
    ...
    disasterIntro: '<p>On October 8, 2005, a devastating earthquake occurred in the autonomous Azad Jammu and Kashmir province of Pakistan. The shock occurred at 8:50 am on a Saturday when many schools and other public buildings were occupied. </p>',
    disasterDescription: '<p>The magnitude 7.6 earthquake had fault rupture of about 100 km in length and about 2,500 km2 in area. Worst affected (in terms of loss of life) were districts in Azad Jammu and Kashmir (AJ-K) province (Muzaffarabad, Bagh and Poonch) and in Khyber Pakhtunkhwa province (Mansehra, Batagram, Kohistan, Abbottabad and Shangla). Muzaffarabad, the capital of the AJ-K province, was very close to the epicenter and around 50% of its buildings including most of the public buildings were destroyed. In total, it was reported that 437,500 and 136,500 houses were destroyed and partially damaged, with around 2.25 million people becoming long-term homeless. Nearly 73,800 people were killed in Pakistan and another 1,200 in India, while the number injured in Pakistan was 128,309, of which 69,412 were seriously injured (an additional 6,266 were injured in India). Six months after the earthquake more than 2,200 injured were still treated in Pakistani hospitals. The exact number of fatalities is not known. It is roughly estimated that around 20,000 to 25,000 could have perished in landslides, mostly in the Khagan, Neelum and Jhelum Valleys. </p>',
